      ...
      <div className={isEnabled ? "modal modal-open" : "modal"}>
        <div className="modal-box">
          ...
          <div className="flex flex-row items-center gap-3">
            <div className="input input-bordered input-sm w-[90%] max-w-xs truncate">
              bad-people-online-game.com/room/{<p>{roomId}</p>}
            </div>
            <button
              className={
                copied
              ...
              onClick={() => {
                copy(`bad-people-online-game.com/room/${roomId}`);
                setCopied(true);
              }}
            >
              <svg
